...
const SERIES = "https://github.com/cuppibla/agent-valley-buildyard";
...
const DISTRICTS = [
  ...
  { id: "buildyard", img: "/world/zones/buildyard.jpg", chip: "02 · DECOMPOSE",
    name: "The Buildyard", href: "/w2", open: true, status: "OPEN" },
  ...
  return (
    <div className="wrap">
      <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: 22, alignItems: "center",
        marginBottom: 26 }}>
        <div>
          <div className="eyebrow">AGENT 101 · CHAPTER TWO</div>
          ...
          <p style={{ color: "var(--sub)", fontSize: 15, margin: 0, maxWidth: "40ch", lineHeight: 1.6 }}>
            One agent cannot hold a whole job. Watch a crew take one.
          </p>
          <div style={{ display: "flex", gap: 10, marginTop: 18, alignItems: "center" }}>
            <Link href="/w2" style={{ textDecoration: "none", padding: "12px 26px", borderRadius: 13,
